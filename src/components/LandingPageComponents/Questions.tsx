  ...
  return (
    <div id="questionsDiv">
      ...
      <h2 style={{ display: "inline-block" }}>
        Contact us about business inquiries
      </h2>
      <button
        id="hereButton"
        onClick={() => {
          navigate("/contact");
          const element = document.getElementById("LandingPageTop");
          if (element !== null) {
      ...
      <h2>
        Please see our Frequently Asked Questions page to find the answer to
        your question or submit your own!
      </h2>
